...
.method public static declared-synchronized getInstance()Lcom/heyzap/house/handler/AttributionHandler;
    ...
    .prologue
    .line 150
    const-class v1, Lcom/heyzap/house/handler/AttributionHandler;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/heyzap/house/handler/AttributionHandler;->ref:Lcom/heyzap/house/handler/AttributionHandler;

    if-nez v0, :cond_0

    .line 151
    new-instance v0, Lcom/heyzap/house/handler/AttributionHandler;

    invoke-direct {v0}, Lcom/heyzap/house/handler/AttributionHandler;-><init>()V

    sput-object v0, Lcom/heyzap/house/handler/AttributionHandler;->ref:Lcom/heyzap/house/handler/AttributionHandler;
...
.method public didInstall(Landroid/content/Context;Ljava/util/ArrayList;Ljava/lang/Boolean;)V
    ...
    invoke-static {p1, v1, v0, v2}, Lcom/heyzap/common/net/APIClient;->post(Landroid/content/Context;Ljava/lang/String;Lcom/heyzap/http/RequestParams;Lcom/heyzap/http/AsyncHttpResponseHandler;)V
...
.method public doSelfInstall(Landroid/content/Context;)V
    ...
    invoke-static {p1, v2, v0, v3}, Lcom/heyzap/common/net/APIClient;->post(Landroid/content/Context;Ljava/lang/String;Lcom/heyzap/http/RequestParams;Lcom/heyzap/http/AsyncHttpResponseHandler;)V
