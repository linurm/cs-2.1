...
.method public onFetchSuccess(Lorg/json/JSONObject;)Ljava/util/List;
    ...
    .line 67
    invoke-virtual {v2}, Lcom/heyzap/house/abstr/AbstractFetchHandler$AlreadyInstalledException;->getMessage()Ljava/lang/String;
    ...
    .line 56
    new-instance v2, Lcom/heyzap/house/abstr/AbstractFetchHandler$AlreadyInstalledException;
    ...
    invoke-direct {v2, p0, v6}, Lcom/heyzap/house/abstr/AbstractFetchHandler$AlreadyInstalledException;-><init>(Lcom/heyzap/house/abstr/AbstractFetchHandler;Ljava/lang/String;)V
    ...
    invoke-direct {v6, v2}, Lcom/heyzap/house/model/NativeModel;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v2}, Lcom/heyzap/house/request/FetchRequest;->getTag()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v6, v2}, Lcom/heyzap/house/model/NativeModel;->setTag(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v2, v7}, Lcom/heyzap/house/model/NativeModel;->doPostFetchActions(Landroid/content/Context;Lcom/heyzap/house/model/AdModel$ModelPostFetchCompleteListener;)V

    .line 62
    sget-object v2, Lcom/heyzap/internal/Constants$AdUnit;->NATIVE:Lcom/heyzap/internal/Constants$AdUnit;

    invoke-virtual {v6, v2}, Lcom/heyzap/house/model/NativeModel;->setAdUnit(Lcom/heyzap/internal/Constants$AdUnit;)V
    ...
    invoke-virtual {v0, v2, v5, v3}, Lcom/heyzap/house/handler/AttributionHandler;->didInstall(Landroid/content/Context;Ljava/util/ArrayList;Ljava/lang/Boolean;)V
