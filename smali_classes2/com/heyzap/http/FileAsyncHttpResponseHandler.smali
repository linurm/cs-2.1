...
.method public getResponseData(Lorg/apache/http/HttpEntity;)[B
    ...
    invoke-virtual {p0, v1, v6}, Lcom/heyzap/http/FileAsyncHttpResponseHandler;->sendProgressMessage(II)V
    :try_end_0
    ...
    instance-of v2, v0, Lorg/apache/http/conn/EofSensorInputStream;
    ...
    invoke-virtual {v0}, Lorg/apache/http/conn/EofSensorInputStream;->abortConnection()V
    ...
    .line 126
    :cond_0
    instance-of v1, v0, Lorg/apache/http/conn/EofSensorInputStream;
